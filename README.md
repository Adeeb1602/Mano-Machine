...
**📄 Project Report:** The full technical details, including block diagrams, pin maps, and testbench waveforms, can be found in the [**Docs/**](https://www.google.com/search?q=Docs/) directory.
...
│   ├── generate\_fsm.py     \# The Generator Script  
│   ├── fsm\_core\_template.v \# The Verilog Template  
...
3. Assign pins according to the **Pin Map** (see Docs/Project\_Report.pdf).  
